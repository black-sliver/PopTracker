...
$(WIN64_BENCH_EXE): native_bench_impl
	...
	cp "$(TMP_NATIVE_BUILD_DIR)/bench/$(BENCH_EXE_NAME).exe" $@
$(WIN64_ZIP): $(WIN64_EXE)
	./win32/package.sh "$(TMP_NATIVE_BUILD_DIR)"
else
...
$(WIN64_ZIP): $(WIN64_EXE)
	./win32/package.sh "$(TMP_CROSS_WIN64_BUILD_DIR)"
endif
...
$(NIX_XZ): $(NIX_EXE)
	./linux/package.sh "$(TMP_NATIVE_BUILD_DIR)"
...
$(OSX_ZIP): $(NIX_EXE)
	./macosx/package.sh "$(TMP_NATIVE_BUILD_DIR)"
