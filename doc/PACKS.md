...
* `bool :OpenLink(url, description)`: prompts user to open web page using default browser. Returns `true` if URL validation passes, `false` otherwise. Only available in PopTracker
